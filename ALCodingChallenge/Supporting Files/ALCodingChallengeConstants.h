...
#define kShortPressCenterCellMaxScale 1.2
#define kShortPressCenterCellAnimationDuration 0.3
#define kUserImageSmallScreenBottomConstraint 45.f
#define kMixDetailUserImageYTranslation -70.f
#define kMixDetailPlayAnimationDuration 0.2

#define kSpringDefaultDamping .8
